...
/obj/item/integrated_circuit/text/regex_finder
	...
	extended_desc = "Takes a string(haystack) and finds a certain regular expression, which has to be under 11 characters big. This gives out the exact text and its position."
	spawn_flags = IC_SPAWN_DEFAULT|IC_SPAWN_RESEARCH
	inputs = list(
		"haystack" = IC_PINTYPE_STRING,
...
/obj/item/integrated_circuit/text/regex_finder/do_work()
	if(length(get_pin_data(IC_INPUT, 2)) > 10)
		return
...
/obj/item/integrated_circuit/text/regex_replacer
	...
	extended_desc = "Takes a string(haystack) and finds a certain regular expression, which has to be under 11 characters big. This gives out the string with replaced regular expression."
	spawn_flags = IC_SPAWN_DEFAULT|IC_SPAWN_RESEARCH
	inputs = list(
		"haystack" = IC_PINTYPE_STRING,
		"needle" = IC_PINTYPE_STRING,
